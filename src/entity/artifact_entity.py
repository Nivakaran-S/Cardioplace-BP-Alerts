...
class ModelTrainerArtifact:
    ...
    offset_metric_artifact: Optional[OffsetMetricArtifact] = None
    rule_engine_artifact: Optional[RuleEngineArtifact] = None
    safety_gate_artifact: Optional[SafetyGateArtifact] = None
